// Product catalogue for Parkolyn Amsterdam. Edit this file to add, remove,
// or change products, prices, and descriptions. `image` fields are optional
// — leave them unset (or pointing at a file that doesn't exist yet in
// /public/media/products/) and the site falls back to a designed bottle
// illustration automatically.
//
// `category` is forward-compat for when cosmetics and apparel join the
// catalogue — everything today is "fragrance".
