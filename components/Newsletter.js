      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3 sm:flex-row">
          <input
            ...
            className="w-full rounded-full border hairline bg-transparent px-5 py-3 text-sm text-cream placeholder:text-cream-dim/50 focus:border-gold focus:outline-none"
          />
          <button
            type="submit"
